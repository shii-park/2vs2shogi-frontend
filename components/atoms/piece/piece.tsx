...
export function PieceDraw({ topPiece, phase, selectedPiece, myTeam, onClick, onMouseEnter, onMouseLeave }: Props) {
    ...
    const pieceClass = [
        ...
        selectedPiece === topPiece && 'isSelected',
        selectedPiece !== null && selectedPiece !== topPiece && 'otherSelected',
        selectedPiece === null && 'noneSelected',
        // pieceのクラスはここに追加
    ]
        .filter(Boolean)
        .join(' ');
